...
import { getProductos, getProductosPorVencer, getProductosEnStock, getProductosPorFechaIngreso, getMovimientos, getMovimientosPorUsuario, getMovimientosPorFecha, getMovimientosPorProducto, getMovimientosPorTipo, getLaboratorios, getLaboratorioPorId, getProductosPorLaboratorio, getUsuarios, getUsuarioPorId, getUsuariosPorRol } from '../CONTROLLER/informes.controller.js';
...
router.get('/laboratorios/productos/:laboratorioId', getProductosPorLaboratorio);
