...
function Movimiento() {
  ...
  const getPendientesDevolucion = async () => {
    try {
      const response = await axios.get(
        "http://localhost:4000/api/movimientos/devoluciones/pendientes"
      );
  ...
  const handleSubmitDevolucion = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:4000/api/movimientos/devoluciones/${movimientoSeleccionadoDevolucion.ID_STOCK}`,
        {
