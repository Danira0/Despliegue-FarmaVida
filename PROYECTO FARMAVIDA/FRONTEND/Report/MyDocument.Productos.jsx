...
export const MyDocumentProductos = ({
  ...
  fechaInicio, 
  fechaFin,
  diasVencer // Nuevo parámetro para días a vencer
}) => {
      ...
      try {
        ...
        switch (reportType) {
          case "todos":
            ...
            break;
          case "vencer":
            endpoint = "http://localhost:4000/api/productos/por-vencer";
            params = { dias: diasVencer || 90 };
            break;
          case "fecha-ingreso":
            endpoint = "http://localhost:4000/api/productos/por-fecha-ingreso";
            params = { fechaInicio, fechaFin };
            break;
          case "stock":
            endpoint = "http://localhost:4000/api/productos/en-stock";
            break;
          default:
            endpoint = "http://localhost:4000/api/productos";
        }    
